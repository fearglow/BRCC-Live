...
if (!class_exists('ST_Elementor_Hook')) {
    class ST_Elementor_Hook
    {
        ...
        public function _addSettingStyleDestination($layout_style){
            $lists_style = [
                'tab' => esc_html__('Tab', 'traveler-layout-essential-for-elementor'),
            ];
        ...
        {
            $lists_style = [
                'style-lib-1' => esc_html__('Style Lib 1', 'traveler-layout-essential-for-elementor'),
                'style-lib-2' => esc_html__('Style Lib 2', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-1' => esc_html__('Style Lib Slider 1', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-2' => esc_html__('Style Lib Slider 2', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-3' => esc_html__('Style Lib Slider 3', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-4' => esc_html__('Style Lib Slider 4', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-5' => esc_html__('Style Lib Slider 5', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-6' => esc_html__('Style Lib Slider 6', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-7' => esc_html__('Style Lib Slider 7', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-8' => esc_html__('Style Lib Slider 8', 'traveler-layout-essential-for-elementor'),
            ];
        ...
        {
            $lists_style = [
                'style-4'  => esc_html__('Style 4', 'traveler-layout-essential-for-elementor'),
                'style-5'  => esc_html__('Style 5', 'traveler-layout-essential-for-elementor'),
                'style-6'  => esc_html__('Style 6', 'traveler-layout-essential-for-elementor'),
                'style-nav-top'  => esc_html__('Style Nav Top', 'traveler-layout-essential-for-elementor'),
        ...
        {
            $lists_style = [
                'grid-style2' => esc_html__('Grid Style 2', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-1' => esc_html__('Style Lib Slider 1', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-2' => esc_html__('Style Lib Slider 2', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-3' => esc_html__('Style Lib Slider 3', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-4' => esc_html__('Style Lib Slider 4', 'traveler-layout-essential-for-elementor'),
                ...
                'style-lib-slider-7' => esc_html__('Style Lib Slider 7', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-8' => esc_html__('Style Lib Slider 8', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-9' => esc_html__('Style Lib Slider 9', 'traveler-layout-essential-for-elementor'),
                'style-lib-slider-10' => esc_html__('Style Lib Slider 10', 'traveler-layout-essential-for-elementor'),
            ];
            $array_lists = array_merge($lists, $lists_style);
        ...
        {
            $lists_style = [
                'style1' => esc_html__('Style 1', 'traveler-layout-essential-for-elementor'),
                'style2' => esc_html__('Style 2', 'traveler-layout-essential-for-elementor'),
                'style3' => esc_html__('Style 3', 'traveler-layout-essential-for-elementor'),
                'style4' => esc_html__('Style 4', 'traveler-layout-essential-for-elementor'),
                'style5' => esc_html__('Style 5', 'traveler-layout-essential-for-elementor'),
                'style6' => esc_html__('Style 6', 'traveler-layout-essential-for-elementor'),
                'style7' => esc_html__('Style 7', 'traveler-layout-essential-for-elementor'),
                'style8' => esc_html__('Style 8', 'traveler-layout-essential-for-elementor'),
            ];
            $array_lists = array_merge($lists, $lists_style);
        ...
        public function _travelerNewsletter()
        {
            ...
            if (empty($api_key)) {
                echo wp_json_encode([
                    'status' => 0,
                    'message' => esc_html__('Email server configuration incorrect', 'traveler-layout-essential-for-elementor')
                ]);
            }
            if (empty($email)) {
                return [
                    'status' => 0,
                    'message' => esc_html__('Email Address is incorrect', 'traveler-layout-essential-for-elementor')
                ];
            }
            $data = array(
                'apikey' => $api_key,
            ...
            if (isset($response['errors']) && $response['status'] === 400) {
                ...
                if ($response['response']['code'] !== 200) {
                    ...
                    $message = ($status_email == 'subscribed') ? esc_html__('You have been successfully subscribed', 'traveler-layout-essential-for-elementor') : esc_html__('Your request will be confirmed by the administrator', 'traveler-layout-essential-for-elementor');
                    echo wp_json_encode([
                        'status' => 1,
                        'message' => $message,
                    ]);
        ...
        {
            $lists_style = [
                'style_3'  => esc_html__('Style 3', 'traveler-layout-essential-for-elementor'),
            ];
            $array_lists = array_merge($lists, $lists_style);
