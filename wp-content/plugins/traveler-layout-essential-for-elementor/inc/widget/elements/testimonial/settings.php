...
if (!class_exists('ST_Testimonial_Element')) {
    class ST_Testimonial_Element extends \Elementor\Widget_Base
    {
        ...
        {
            return esc_html__('Testimonial', 'traveler-layout-essential-for-elementor');
        }
        ...
        protected function register_controls()
        {
            $st_style_testimonial = apply_filters('st_style_testimonial', [
                    'normal'  => esc_html__('Normal', 'traveler-layout-essential-for-elementor'),
                    'slider' => esc_html__('Style slider 1', 'traveler-layout-essential-for-elementor'),
                    'slider-2' => esc_html__('Style slider 2', 'traveler-layout-essential-for-elementor'),
                    'slider-3' => esc_html__('Style slider 3', 'traveler-layout-essential-for-elementor'),
            ]);
            ...
            $this->add_control(
                'start_color',
                [
                    'label' => esc_html__('Start Color', 'traveler-layout-essential-for-elementor'),
