                        ...
                        <div class="services-item grid item-elementor" itemscope>
                            <div class="item service-border">
                                ...
                                <div class="content-item">
                                    ...
                                    <div class="readmore">
                                        <a href="<?php echo get_the_permalink(); ?>"><?php echo esc_html__('Read more', 'traveler-layout-essential-for-elementor') ?><svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
