...
<div class="field-guest form-group">
    <div class="form-extra-field dropdown dropdown-toggle <?php if ($has_icon) {
        ...
        <div class="st-form-dropdown-icon">
            <label><?php echo __('Guests Number', 'traveler-layout-essential-for-elementor'); ?></label>
            <div class="render">
            <span data-text="<?php echo esc_attr(json_encode([
                    'guest' => esc_attr__('guest', 'traveler-layout-essential-for-elementor'),
                    'guests' => esc_attr__('guests', 'traveler-layout-essential-for-elementor')
                                                          ])); ?>">
             <?php
                if (!empty($adult_number) || !empty($room_num_search)) {
                    echo sprintf(_n('%s guest', '%s guests', (intval($adult_number + $child_number)), 'traveler-layout-essential-for-elementor'), ( intval($adult_number + $child_number) ));
                } else {
                    echo esc_html__('Add guests', 'traveler-layout-essential-for-elementor');
                }
                ?>
