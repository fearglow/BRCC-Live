...
if (!class_exists('ST_Form_Search_Agency_Element')) {
    ...
    class ST_Form_Search_Agency_Element extends \Elementor\Widget_Base
    {
        ...
        {
            return esc_html__('Form Search Room/Rental', 'traveler-layout-essential-for-elementor');
        }
        ...
        protected function register_controls()
        {
            ...
            $this->add_control('link_page_search', [
                'label' => esc_html__('Link page search', 'traveler-layout-essential-for-elementor'),
            ...
            $this->add_control('type', [
                ...
                'type' => 'select',
                'options' => [
                    'search_room' => esc_html__('Search room', 'traveler-layout-essential-for-elementor'),
                    'search_rental' => esc_html__('Search rental', 'traveler-layout-essential-for-elementor'),
                ],
                'default' => 'search_room',
            ...
            $this->add_control(
                'border_type',
                [
                    'label' => esc_html__('Border Type', 'traveler-layout-essential-for-elementor'),
            ...
            $this->add_control(
                'bg_color_style2',
                [
                    'label' => esc_html__('Background Color Style 2', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->add_control(
                'icon_color',
                [
                    'label' => esc_html__('Icon Color', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
            ...
            $this->add_control(
                'label_color',
                [
                    'label' => esc_html__('Label Color', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'default' => 'var(--grey-color,#5E6D77)',
                    'selectors' => [
            ...
            $this->add_control(
                'text_color',
                [
                    'label' => esc_html__('Text Color', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Style Button', 'traveler-layout-essential-for-elementor'),
                    'tab' => Controls_Manager::TAB_STYLE,
                    'default' => 'single',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    'label' => esc_html__('Background Button Color Hover', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'default' => 'var(--main-color, #3B71FE)',
                    'selectors' => [
            ...
            $this->add_control(
                'title_color_hover',
                [
                    'label' => esc_html__('Title Color Hover', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
                        '{{WRAPPER}} .st_search_room .search-form form .form-button:hover' => 'color: {{VALUE}};',
