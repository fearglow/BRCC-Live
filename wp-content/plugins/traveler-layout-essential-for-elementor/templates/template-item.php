    ...
    <div class="traveler-essential-modal-sidebar-inner">
        <div class="traveler-essential-categories traveler-essential-packs-categories">
            <ul class="traveler-essential-sidebar-menu">
                <li class="traveler-essential-sidebar-menu-item traveler-essential-active"  id="all"><span><?php echo __("All Categories", "traveler-layout-essential-for-elementor");?></span></li>
    ...
    <div class="traveler-essential-items-header-wrapper ">
        <div class="traveler-essential-items-header-wrapper-inner">
            <div class="traveler-essential-items-header">
                <?php if ($type === "page") {
                    ?><h3><?php echo __("All Pages", "traveler-layout-essential-for-elementor") ?></h3><?php
                } ?>
                <?php if ($type === "section") {
                    ?><h3><?php echo __("All Sections", "traveler-layout-essential-for-elementor") ?></h3><?php
                } ?>
                <?php if ($type === "container") {
                    ?><h3><?php echo __("All Blocks", "traveler-layout-essential-for-elementor") ?></h3><?php
                } ?>
            </div>
        </div>
    </div>
            ...
            <div class="traveler-essential-single-item traveler-essential-pack tab-<?php echo esc_attr($value["cateID"]);?>C">
                <div class="traveler-essential-single-item-box">
                    <div class="traveler-essential-item-image">
                        <div class="box-label"><span><?php echo esc_html('Free', 'traveler-layout-essential-for-elementor') ?></span></div>
                        <img
