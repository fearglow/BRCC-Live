...
class EDD_SL_Plugin_Updater {
	...
	public function show_changelog() {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			wp_die( esc_html__( 'You do not have permission to install plugin updates', 'gravity-forms-pdf-extended' ), esc_html__( 'Error', 'gravity-forms-pdf-extended' ), array( 'response' => 403 ) );
		}
