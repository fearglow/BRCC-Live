...
if (!function_exists('st_checkout_fieldtype_dropdown')) {
    function st_checkout_fieldtype_dropdown($field_name, $field)
    {
        $default = [
            'label' => '',
            'placeholder' => '',
        ...
        <div class="col-sm-<?php echo esc_attr($size) ?>">
            <div class="form-group">
                <label for="field-<?php echo esc_attr($field_name) ?>"><?php echo balanceTags($label) ?> <?php echo balanceTags($required) ?> </label>
                <select class="<?php echo implode(' ', $class) ?>" id="field-<?php echo esc_attr($field_name) ?>" name="<?php echo esc_attr($field_name) ?>">
