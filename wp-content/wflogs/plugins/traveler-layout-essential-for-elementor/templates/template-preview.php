<div class="traveler-essential-preview-html-or-image">
    <div class="traveler-essential-block-preview-header">
        <div class="ep-right">
            <button class="ep-preview-insert" data-id="<?php echo esc_attr($id);?>"><?php echo __("Insert", "traveler-layout-essential-for-elementor"); ?><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
