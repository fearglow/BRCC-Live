            ...
            <div class="traveler-essential-modal-header">
                ...
                <div class="traveler-essential-modal-menu">
                    <ul class="travler_nav">
                        <li class="traveler-essential-active"><a href="#pages" data-type="page"><?php echo __("Pages", "traveler-layout-essential-for-elementor") ?></a></li>
                        <li class=""><a href="#section" data-type="section"><?php echo __("Section", "traveler-layout-essential-for-elementor") ?></a></li>
                        <li class=""><a href="#blocks" data-type="container"><?php echo __("Blocks", "traveler-layout-essential-for-elementor") ?></a></li>
                    </ul>
                </div>
