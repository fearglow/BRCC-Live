    ...
    <div class="item service-border st-border-radius">
        ...
        <div class="content-item">
            <div class="price-wrapper d-flex align-items-center" itemprop="priceRange">
                ...
                <span class="unit"><?php echo esc_html__('/ night', 'traveler-layout-essential-for-elementor') ?></span>
            </div>
            ...
            <div class="reviews" itemprop="starRating" itemscope itemtype="https://schema.org/Rating">
                ...
                <span class="summary">
                    . <?php comments_number(esc_html__('No Review', 'traveler-layout-essential-for-elementor'), esc_html__('1 Review', 'traveler-layout-essential-for-elementor'), get_comments_number() . ' ' . esc_html__('Reviews', 'traveler-layout-essential-for-elementor')); ?>
                </span>
            </div>
            <div class="section-footer">
                <div class="room-featured-items">
                    <div class="item" data-bs-toggle="tooltip" title="<?php echo esc_attr__('No. People', 'traveler-layout-essential-for-elementor') ?>">
                    ...
                    <div class="item" data-bs-toggle="tooltip" title="<?php echo esc_attr__('No. Bed', 'traveler-layout-essential-for-elementor') ?>">
                        <span class="stt-icon-bed"></span>
                        <?php echo (int)get_post_meta(get_the_ID(), 'rental_bed', true) ?>
                    </div>
                    <div class="item" data-bs-toggle="tooltip" title="<?php echo esc_attr__('No. Bathroom', 'traveler-layout-essential-for-elementor') ?>">
                        <span class="stt-icon-bathtub"></span>
                        <?php echo (int)get_post_meta(get_the_ID(), 'rental_bath', true) ?>
                    </div>
                    <div class="item" data-bs-toggle="tooltip" title="<?php echo esc_attr__('Square', 'traveler-layout-essential-for-elementor') ?>">
                        <span class="stt-icon-area"></span>
                        <?php echo (int)get_post_meta(get_the_ID(), 'rental_size', true); ?><?php echo __('m<sup>2</sup>', 'traveler-layout-essential-for-elementor'); ?>
                    </div>
                </div>
                <a href="<?php echo esc_url($url); ?>" class="btn btn-primary btn-search st-button-main" target="_blank"><?php echo __('Room detail', 'traveler-layout-essential-for-elementor'); ?></a>
            </div>
        </div>
    </div>
</div>
