...
if (!class_exists('ST_Slider_Room_Element')) {
    class ST_Slider_Room_Element extends \Elementor\Widget_Base
    {
        ...
        {
            return esc_html__('ST Slider Room', 'traveler-layout-essential-for-elementor');
        }
        ...
        protected function register_controls()
        {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'description' => esc_html__('Choose multi room you need display', 'traveler-layout-essential-for-elementor'),
                    'type' => 'select2_ajax',
            ...
            $this->start_controls_section(
                ...
                [
                    'label' => esc_html__('Settings Title', 'traveler-layout-essential-for-elementor'),
