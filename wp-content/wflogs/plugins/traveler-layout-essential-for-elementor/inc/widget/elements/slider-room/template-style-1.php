                    ...
                    ?>
                        <div class="swiper-slide">
                            <div class="st-img">
                                ...
                                <a class="btn" href="<?php echo esc_url(get_permalink($key)); ?>" itemprop="priceRange"><?php echo esc_html__('starting at ', 'traveler-layout-essential-for-elementor'); ?><?php echo TravelHelper::format_money($price_ori) ?></a>
                            </div>
                        </div>
                <?php }
                ?>
