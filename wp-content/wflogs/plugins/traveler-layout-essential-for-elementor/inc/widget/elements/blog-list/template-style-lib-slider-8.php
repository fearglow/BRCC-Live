                            ...
                            <div class="item">
                                ...
                                <div class="content-item">
                                    ...
                                    <div class="read-more-lib">
                                        <a href="<?php echo get_the_permalink(); ?>"><?php echo esc_html("Read more", "traveler-layout-essential-for-elementor") ?><span class="stt-icon stt-icon-arrow-right-1"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
