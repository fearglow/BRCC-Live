...
<div class="field-guest form-group">
    <div class="form-extra-field dropdown dropdown-toggle <?php if ($has_icon) {
        ...
        <div class="st-form-dropdown-icon">
            <label><?php echo __('Guests', 'traveler-layout-essential-for-elementor'); ?></label>
            <div class="render">
                <span class="adult" data-text="<?php echo __('Adult', 'traveler-layout-essential-for-elementor'); ?>"
                    data-text-multi="<?php echo __('Adults', 'traveler-layout-essential-for-elementor'); ?>"><?php echo sprintf(_n('%s Adult', '%s Adults', esc_attr($adult_number), 'traveler-layout-essential-for-elementor'), esc_attr($adult_number)) ?></span>
                -
                <span class="children" data-text="<?php echo __('Child', 'traveler-layout-essential-for-elementor'); ?>"
                    data-text-multi="<?php echo __('Children', 'traveler-layout-essential-for-elementor'); ?>"><?php echo sprintf(_n('%s Child', '%s Children', esc_attr($child_number), 'traveler-layout-essential-for-elementor'), esc_attr($child_number)); ?></span>
            </div>
        </div>
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdown-1">
        <li class="item d-flex align-items-center justify-content-between">
            <label><?php echo esc_html__('Adults', 'traveler-layout-essential-for-elementor') ?></label>
        ...
        <li class="item d-flex align-items-center justify-content-between">
            <label><?php echo esc_html__('Children', 'traveler-layout-essential-for-elementor') ?></label>
            <div class="select-wrapper">
                <div class="st-number-wrapper d-flex align-items-center justify-content-between">
    ...
    if (get_post_meta(get_the_ID(), 'disable_adult_name', true) == 'off') { ?>
            <div class="guest_name_input d-none"
                data-placeholder="<?php echo esc_html__('Guest %d name', 'traveler-layout-essential-for-elementor') ?>"
                ...
                >
                <label><span><?php echo esc_html__('Guest Name', 'traveler-layout-essential-for-elementor') ?></span> <span class="required">*</span></label>
                        ...
                        foreach ($controls as $k => $control) {
                            ...
                            <div class="control-item mb10">
                                <select name="guest_title[]" class="form-control">
                                    <option value="mr" <?php selected('mr', isset($guest_titles[$k]) ? $guest_titles[$k] : '') ?>><?php echo esc_html__('Mr', 'traveler-layout-essential-for-elementor') ?></option>
                                    <option value="miss" <?php selected('miss', isset($guest_titles[$k]) ? $guest_titles[$k] : '') ?> ><?php echo esc_html__('Miss', 'traveler-layout-essential-for-elementor') ?></option>
                                    <option value="mrs" <?php selected('mrs', isset($guest_titles[$k]) ? $guest_titles[$k] : '') ?>><?php echo esc_html__('Mrs', 'traveler-layout-essential-for-elementor') ?></option>
                                </select>
                                <?php printf('<input class="form-control " placeholder="%s" name="guest_name[]" value="%s">', sprintf(esc_html__('Guest %d name', 'traveler-layout-essential-for-elementor'), $k + 2), esc_attr($control)); ?>
                            </div>
                            <?php
                        }
                    }
                ...
                <script type="text/html" id="guest_name_control_item">
                    <div class="control-item mb10">
                        <select name="guest_title[]" class="form-control">
                            <option value="mr"><?php echo esc_html__('Mr', 'traveler-layout-essential-for-elementor') ?></option>
                            <option value="miss"><?php echo esc_html__('Miss', 'traveler-layout-essential-for-elementor') ?></option>
                            <option value="mrs"><?php echo esc_html__('Mrs', 'traveler-layout-essential-for-elementor') ?></option>
                        </select>
                    <?php printf('<input class="form-control " placeholder="%s" name="guest_name[]" value="">', esc_html__('Guest  name', 'traveler-layout-essential-for-elementor')); ?>
                    </div>
                </script>
            </div>
    <?php }
