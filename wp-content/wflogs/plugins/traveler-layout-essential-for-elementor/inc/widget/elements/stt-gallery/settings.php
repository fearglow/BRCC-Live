...
if (!class_exists('ST_Stt_Gallery_Element')) {
    class ST_Stt_Gallery_Element extends \Elementor\Widget_Base
    {
        ...
        {
            return esc_html__('ST Gallery', 'traveler-layout-essential-for-elementor');
        }
        ...
        protected function register_controls()
        {
            ...
            $repeater->add_control(
                'name_tab_gallery',
                [
                    'label' => esc_html__('Name Tab Gallery', 'traveler-layout-essential-for-elementor'),
            ...
            $this->add_control(
                'list_gallery',
                [
                    'label' => esc_html__('List Gallery', 'traveler-layout-essential-for-elementor'),
