...
if (!class_exists('ST_Counter_Element')) {
    ...
    class ST_Counter_Element extends \Elementor\Widget_Base
    {
        ...
        {
            return esc_html__('Counter', 'traveler-layout-essential-for-elementor');
        }
        ...
        protected function register_controls()
        {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'options' => [
                        'relative' => esc_html__('Relative', 'traveler-layout-essential-for-elementor'),
                        'absolute'  => esc_html__('Absolute', 'traveler-layout-essential-for-elementor'),
                    ],
                    'default' => 'relative',
                    'selectors' => [
            ...
            $this->add_control(
                'title_offset',
                [
                    'label' => esc_html__('Offset', 'traveler-layout-essential-for-elementor'),
            ...
            $this->add_control(
                'number_color',
                [
                    'label' => esc_html__('Number Color', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'global' => [
                        'default' => Global_Colors::COLOR_SECONDARY,
                    ],
            ...
            $this->add_control(
                'number_fill_color',
                [
                    'label' => esc_html__('Number Fill Color', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'global' => [
                        'default' => Global_Colors::COLOR_SECONDARY,
                    ],
            ...
            $this->add_control(
                'number_stroke_width',
                [
                    'label' => esc_html__('Number Stroke Width', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range' => [
                        'px' => [
            ...
            $this->add_control(
                'number_stroke_color',
                [
                    'label' => esc_html__('Number Stroke Color', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::COLOR,
                    'global' => [
                        'default' => Global_Colors::COLOR_SECONDARY,
                    ],
            ...
            $this->add_responsive_control(
                'number_space',
                [
                    'label' => esc_html__('Number Space', 'traveler-layout-essential-for-elementor'),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => [ 'px', '%' ],
                    'range' => [
                        'px' => [
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'left' => esc_html__('Left', 'traveler-layout-essential-for-elementor'),
                        'absolute'  => esc_html__('Absolute', 'traveler-layout-essential-for-elementor'),
                    ],
                    'default' => 'top',
                ]
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'label' => esc_html__('Item margin', 'traveler-layout-essential-for-elementor'),
                    'size_units' => [ 'px', 'em', '%' ],
                    'default' => [
                        'top' => '0',
                        'right' => '0',
