...
<div class="payment-form">
    <h3 class="title"><?php echo __('Select Payment Method', 'traveler'); ?></h3>
    <?php
    if ( !isset( $post_id ) ) $post_id = false;
    STPaymentGateways::get_payment_gateways_html( $post_id, 'style-2') ?>
</div>
...
<a data-action='st_checkout' id ="demo-form" class="btn btn-primary btn-checkout btn-st-checkout-submit btn-st-big "><?php _e( 'Submit', 'traveler' ) ?> <span class="stt-icon stt-icon-arrow-right-1"></span> <i class="fa fa-spinner fa-spin"></i></a>
