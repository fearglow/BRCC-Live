...
// Debugging: Print current user roles
...
<?php } else { ?>
    ...
    <div class="page-wrapper chiller-theme <?php echo esc_attr($toggled);?>">
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-menu">
                    <ul>
						...
						<!-- Add new menu item for "Mobile Booking Module" -->
						<?php if (in_array('host', $current_user->roles)) : ?>
							<li class="<?php echo ($_GET['sc'] == 'mobile-booking-module') ? 'active' : '';?>">
								<a href="<?php echo add_query_arg('sc', 'mobile-booking-module', get_permalink()); ?>">
									<img src="<?php echo get_template_directory_uri()."/v2/images/dashboard/ico_overview.svg";?>" alt="" class="st-icon-menu">
									<span><?php _e("Daily Check-In", 'traveler') ?></span>
								</a>
							</li>
						<?php endif; ?>

						<!-- Add new menu item for "Host Dashboard" -->
						<?php if (in_array('host', $current_user->roles)) : ?>
							<li class="<?php echo ($_GET['sc'] == 'host-dashboard') ? 'active' : '';?>">
								<a href="<?php echo add_query_arg('sc', 'host-dashboard', get_permalink()); ?>">
									<img src="<?php echo get_template_directory_uri()."/v2/images/dashboard/ico_dashboard.svg";?>" alt="" class="st-icon-menu">
									<span><?php _e("Host Dashboard", 'traveler') ?></span>
								</a>
							</li>
						<?php endif; ?>
        ...
        <main class="page-content">
                    ...
                    if (STUser_f::check_lever_service_partner($sc, $lever)) {
                        switch ($sc) {
                            ...
                            case "create-flight";
                                ...
                                break;
                           case "host-dashboard":
								echo st()->load_template('user/user', 'host-dashboard', get_object_vars($current_user));
								return;
								
							case "mobile-booking-module":
								echo st()->load_template('user/user', 'mobile-booking-module', get_object_vars($current_user));
								return;
                }
            ...
            $arr_page_menu = ["mobile-booking-module", "host-dashboard", "overview", "setting", "setting-info", "wishlist", "booking-history", "certificate", "write_review", "inbox"];
